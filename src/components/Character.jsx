...
function Character({ id, title, age, category, description }) {
	const defaultText =
	...
	return (
		<div className="flex flex-col">
			...
			<div className="mt-4">
				...
				<h3 className="text-base">Category: {category ? category : "Default"}</h3>
				<p className="mt-2">{description ? description : defaultText}</p>
			</div>
		</div>
	);
}
